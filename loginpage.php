          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-12 col-md-6 my-auto">
              <div class="copyright text-center text-sm text-white text-lg-start">
                ...
                <a href="http://localhost/project/home.html" class="font-weight-bold text-white" target="_blank">SalesPilot</a>
            ...
            <div class="col-12 col-md-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="http://localhost/project/home.html" class="nav-link text-white" target="_blank">SalesPilot</a>
                </li>
                <li class="nav-item">
                  <a href="http://localhost/project/home.html" class="nav-link text-white" target="_blank">About Us</a>
                </li>
              </ul>
            </div>
          </div>
