                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                      ...
                      <li class=" ">
                          ...
                          <ul id="people" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                  ...
                                  <li class="">
                                          <a href="https://salespilot.cybertrendhub.store/project/backend/page-add-customers.php">
                                              <i class="las la-minus"></i><span>Add Customers</span>
                                          </a>
                                  </li>
                                  <li class="">
                                          <a href="https://salespilot.cybertrendhub.store/project/backend/page-list-staffs.php">
                                              <i class="las la-minus"></i><span>Staffs</span>
                                          </a>
                                  </li>
                                  <li class="">
                                          <a href="https://salespilot.cybertrendhub.store/project/backend/page-add-staffs.php">
