...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Insert new supplier
        $insert_supplier_query = "INSERT INTO suppliers (supplier_name, product_name, email, phone_no, location, note, supply_qty) 
                                  VALUES (:supplier_name, :product_name, :email, :phone_no, :location, :note, :supply_qty)";
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="page-add-suppliers.php" method="POST" data-toggle="validator">
                            <div class="row"> 
                                <div class="col-md-12">
