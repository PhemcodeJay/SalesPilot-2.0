...
try {
    ...
    // Fetch products from the database with their categories
    $fetch_products_query = "SELECT p.id, p.name, p.description, p.price, p.image_path, c.category_name AS category_name
                             FROM products p
                ...
                <table class="data-tables table mb-0 tbl-server-info">
                    ...
                    <tbody class="ligth-body">
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="http://localhost/project/assets/images/table/product/01.jpg" class="img-fluid rounded avatar-50 mr-3" alt="image">
                                    <div>
                                        Organic Cream
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="http://localhost/project/assets/images/table/product/02.jpg" class="img-fluid rounded avatar-50 mr-3" alt="image">                                    
                                    <div>
                                        Rain Umbrella
                                        <p class="mb-0"><small>This is test Product</small></p>
                                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="http://localhost/project/assets/images/table/product/03.jpg" class="img-fluid rounded avatar-50 mr-3" alt="image">                                    
                                    <div>
                                        Serum Bottle
                                        <p class="mb-0"><small>This is test Product</small></p>
                                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="http://localhost/project/assets/images/table/product/04.jpg" class="img-fluid rounded avatar-50 mr-3" alt="image">                                    
                                    <div>
                                        Coffee Beans
                                        <p class="mb-0"><small>This is test Product</small></p>
                                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="http://localhost/project/assets/images/table/product/05.jpg" class="img-fluid rounded avatar-50 mr-3" alt="image">
                                    <div>
                                        Book Shelves                                   
                                        <p class="mb-0"><small>This is test Product</small></p>
                                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="http://localhost/project/assets/images/table/product/06.jpg" class="img-fluid rounded avatar-50 mr-3" alt="image">
                                    <div>
                                        Dinner Set                                  
                                        <p class="mb-0"><small>This is test Product</small></p>
                                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="http://localhost/project/assets/images/table/product/07.jpg" class="img-fluid rounded avatar-50 mr-3" alt="image">
                                    <div>
                                        Nike Shoes                               
                                        <p class="mb-0"><small>This is test Product</small></p>
                                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="http://localhost/project/assets/images/table/product/08.jpg" class="img-fluid rounded avatar-50 mr-3" alt="image">
                                    <div>
                                        Computer Glasses                               
                                        <p class="mb-0"><small>This is test Product</small></p>
                                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <img src="http://localhost/project/assets/images/table/product/09.jpg" class="img-fluid rounded avatar-50 mr-3" alt="image">
                                    <div>
                                        Alloy Jewel Set                   
                                        <p class="mb-0"><small>This is test Product</small></p>
                                    </div>
