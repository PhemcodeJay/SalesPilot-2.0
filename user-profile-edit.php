                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                      ...
                      <li class=" ">
                          ...
                          <ul id="category" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                  <li class="">
                                          <a href="https://salespilot.cybertrendhub.store/project/backend/page-list-category.html">
                                              ...
                                              <div class="p-3">
                                                ...
                                                <p class="mb-0">Since <?php echo $date; ?></p>
                                                  <div class="d-flex align-items-center justify-content-center mt-3">
                                                      <a href="https://salespilot.cybertrendhub.store/project/user-profile-edit.html" class="btn border mr-2">Profile</a>
